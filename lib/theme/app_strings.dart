...
class AppStrings {
  static final Map<String, String> enStrings = {
    ...
    '알림 시스템': 'Reminder System',
    '알림 켜기': 'Enable Reminders',
    '알람 간격': 'Reminder Interval',
    ...
    '취소': 'Cancel',
    '저장': 'Save',
    '알림 주기 선택': 'Select Alert Interval',
    ...
    '비밀번호 재설정 메일이 발송되었습니다.': 'A password reset link has been sent.',
    '다음 이메일 주소로 비밀번호 재설정 링크가 발송되었습니다:': 'A password reset link has been sent to the following email address:',
    '메일함을 확인해주세요.': 'Please check your inbox.',
    '계정을 삭제하면 모든 데이터(기록, 설정)가 영구적으로 제거됩니다.\n\n이 작업은 되돌릴 수 없습니다.': 'Deleting your account will permanently remove all your data (logs, settings).\n\nThis cannot be undone.',
    '비밀번호 확인': 'Confirm Password',
    '계정을 삭제하려면 현재 비밀번호를 입력해주세요.': 'Please enter your current password to delete your account.',
    'Google로 재인증': 'Re-authenticate with Google',
    'Apple로 재인증': 'Re-authenticate with Apple',
    '계정을 삭제하려면 Google 계정으로 다시 인증해야 합니다. 계속하시겠습니까?': 'You need to re-authenticate with your Google account to delete your account. Continue?',
    '계정을 삭제하려면 Apple 계정으로 다시 인증해야 합니다. 계속하시겠습니까?': 'You need to re-authenticate with your Apple account to delete your account. Continue?',
    '진행': 'Proceed',
    '비밀번호': 'Password',
    ...
    '메모 내보내기 범위 선택': 'Select Period for Memo Export ',
    '기록 내보내기 범위 선택': 'Select Period for Record Export',
    ...
    '저장하기': 'Save',
    '기상 시간은 이전 취침 시간 이후여야 합니다.': 'Wake time must be after previous sleep time.',
    '취침 시간은 다음날 오전': 'Sleep time is available up to',
    '시까지 설정 가능합니다.': 'am next day.',
    '다음날 오전': 'Set to',
    '시로 설정': 'am next day',
    '취소': 'Cancel',
    '저장': 'Save',
    '로그인 데이터 없음': 'Login Required',
    '삭제 경고': 'Delete Warning',
    '확인 후 삭제': 'Confirm and Delete',
    '개의 날짜에 대한': ' for ',
    '를 삭제하시겠습니까?\n이 작업은 되돌릴 수 없습니다.': ' selected dates?\nThis action cannot be undone.',
    ...
    '계정 및 데이터': 'Account & Data',
    '프로필': 'Profile',
    '알림 주기 선택': 'Select Interval',
    '30분마다 알림': 'Every 30 min',
    '60분마다 알림': 'Every 60 min',
    '다음날': 'Next Day',
    '메모': 'Memo',
    '오늘': 'Today',
    ...
    '기록 삭제': 'Delete Record',
    '메모 삭제': 'Delete Memo',
    '기록 또는 메모를 삭제할 날짜를 선택하세요': 'Select dates to delete records/memos',
    '메모가 있는 날은 배경색이 다릅니다.\n날짜를 클릭하면 기록을 볼 수 있습니다.': 'Dates with memos have colored background.\nTap to view records.',
